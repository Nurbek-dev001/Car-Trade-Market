...
```bash
git clone https://github.com/yourusername/auto-salon.git
cd auto-salon
```
...
**Backend (.env):**
```env
MONGODB_URI=mongodb://localhost:27017/auto_salon
...
- Администратор: `admin@autosalon.kz` / `admin123`
- Менеджер: `manager@autosalon.kz` / `manager123`
- Пользователь: `user@autosalon.kz` / `user123`
